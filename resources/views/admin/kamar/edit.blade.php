...
<div class="max-w-2xl mx-auto p-6 bg-white rounded-xl shadow border">
    <h2 class="text-2xl font-semibold text-gray-800 mb-6 border-b pb-2">Edit Kamar</h2>
    ...
    <form action="{{ route('admin.kamar.update', $kamar->id) }}" method="POST" class="space-y-5">
        @csrf
        @method('PUT')
